<%-- 
    Document   : page2
    Created on : Nov 7, 2019, 6:17:44 PM
    Author     : PC
--%>
                                                            ...
                                                            <div class="cart-buyer">
                                                                <div class="row">
                                                                    <div class="col-md-6 buyer">
                                                                        <p>Người mua hàng : ${requestScope.customer.name} </p>
                                                                        <p>Số điện thoại :${requestScope.customer.mobile}</p>
                                                                        <p>Địa chỉ: ${requestScope.customer.address}</p>
                                                                    </div>
                                                            ...
                                                            <div>
                                                                <c:if test="${bill.order.status eq 3}">
                                                                    ...
                                                                    <c:if test="${bill.order.status eq 4 or bill.order.status eq 3}">
                                                                        <a href="remove?type=user&page=2&orderID=${bill.order.id}"><button type="button" class="btn btn-danger">Hủy đơn hàng</button></a>
                                                                    </c:if>
                                                            </div>
