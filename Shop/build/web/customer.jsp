<%-- 
    Document   : customer
    Created on : Oct 31, 2019, 5:52:35 PM
    Author     : PC
--%>
...
<body>
    ...
    <main>
        <c:if test="${requestScope.page eq 1}" >
            <jsp:include page="customer/page1.jsp"></jsp:include>
        </c:if>
        <c:if test="${requestScope.page eq 2}" >
            <jsp:include page="customer/page2.jsp"></jsp:include>
        </c:if>
        <c:if test="${requestScope.page eq 3}" >
            <jsp:include page="customer/page3.jsp"></jsp:include>
        </c:if>
    ...
    <script>
        ...
        function checkPass(){
            var x = document.forms['form-change']['newPass'].value;
            var y = document.forms['form-change']['reNewPass'].value;
            
            if(x == y){
                document.forms['form-change'].submit();
            }else{
                document.forms['form-change']['reNewPass'].style.border = "1px solid red";
            }
        }
    </script>
